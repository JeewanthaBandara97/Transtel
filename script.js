(function($) {
    ...
    var switcherHtml = '<div class="style-switcher-box"> <div class="switcher-inner"><h5>Style Switcher</h5> <div class="main-list"> <div class="list">  <div class="list layout"> <span class="list-title">Layout</span> <div class="sublist"> <ul class="layout-sw"> <li>Full width</li> <li class="box">Box</li> </ul> </div> </div> </div> </div> <button class="toggle-btn"><i class="fa fa-cog"></i></button> </div>';
   // var blankStyleInject = '<link href="{{ asset("assets/css/blank-color.css") }}" rel="stylesheet" title="switchstyle">';
    ...
    function styleSwitcher() {
        if ($(".style-switcher-box").length) {
            ...
            colorChangerBtn.on("click", function() {
                ...
                targetLink.href = "assets/css/theems/" + styleFileName + ".css";
            });
